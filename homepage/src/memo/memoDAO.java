...
public class memoDAO {
	...
	System.out.println(flag);
	 ...
	 return flag;
		...
		public boolean replyCreate(memoDTO dto) {
			...
			StringBuffer sql = new StringBuffer();
			sql.append(" insert into memo(memono, title, content,passwd, wdate, ");
			...
			try {
				...
				pstmt.setInt(4, dto.getGrpno()); //주의 부모와 같다.
				pstmt.setInt(5, dto.getIndent()+1);
				pstmt.setInt(6, dto.getAnsnum()+1); 
				pstmt.setInt(7, dto.getMemono());
	...
	public boolean create(memoDTO dto) {
		...
		StringBuffer sql = new StringBuffer();
		sql.append(" insert into memo(memono, title, content, passwd, wdate, grpno) ");
		sql.append(" values(memo_seq.nextval, ?, ?, ? , sysdate,   ");
