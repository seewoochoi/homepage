...
<div class="title"><%=title %></div>  
 <div class="content">
<!-- Sidebar -->
<nav class="w3-sidebar w3-black w3-animate-top w3-xxlarge" style="max-width:1000px;display:none;padding-top:140px;
  ...
  <div class="w3-bar-block w3-center" >    
    <a href="<%=root%>/index.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">Home</a><br><br>
     <% if(id==null) {%> 
  
 <a href="member/loginForm.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">로그인</a><br><br>
 
 <%}else{%>
 
 <a href="member/logout.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">로그아웃</a><br><br>
 
 <%} %>
    <a href="member/agreement.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">회원가입</a><br><br>
    <a href="memov3/list.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">업로드 게시판</a><br><br>
    <a href="Img/list.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">이미지 게시판</a><br><br>
    <a href="bbs/list.jsp" class="w3-bar-item w3-button w3-text-grey w3-hover-black">방명록</a><br><br>
