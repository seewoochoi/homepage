...
<div class="bgimg w3-display-container w3-text-white">
  ...
  <b style="color:white; font-size: 45px">냥이들 세상</b></h1>
...
<table cellspacing="0" cellpadding="2"  align="center"> 
 ...
 <jsp:include page="./member/agreement.jsp" />
...
<FORM name='frm' method='POST' action='/member/loginproc' onsubmit="return check(this)" class="form-inline">
